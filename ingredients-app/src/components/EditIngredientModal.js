...
class EditIngredientModal extends Component {
    ...
    updateIngredient() {
        let url = "https://pyyz2y0tzg.execute-api.us-east-1.amazonaws.com/dev/ingredients/" + this.props.editIngredientData.id;
        let updated = {
    ...
    render() {
        return (
            ...
            <ModalHeader toggle={this.props.toggleEditModal}>Update a new ingredient or food item</ModalHeader>
                <ModalBody>
                <FormGroup>
                    <Label for="name">Name</Label>
                    <Input id="name" value={this.props.editIngredientData.name} onChange={this.props.updateName}/>
                </FormGroup>
                <FormGroup>
                    <Label for="price">Price</Label>
                    <Input id="price" value={this.props.editIngredientData.price} onChange={this.props.updatePrice}/>
                </FormGroup>
                <FormGroup>
                    <Label for="stock">Stock</Label>
                    <Input id="stock" value={this.props.editIngredientData.stock} onChange={this.props.updateStock}/>
                </FormGroup>
                </ModalBody>
                <ModalFooter>
